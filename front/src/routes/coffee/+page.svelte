...
<section class="root">
	<section
		class="list"
		class:list-one={amount === 1}
		class:list-two={amount === 2}
		class:list-many={amount > 2}
	>
	...
	<section class="controls">
		...
		{:else if $is_loading_available && $timer_store !== undefined}
			<span class="sidenote"
				>next item will be loaded automatically after {formatTime($timer_store)} seconds</span
			>
		{:else}
